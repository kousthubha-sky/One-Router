...
function TwilioSetupContent() {
  ...
  const save = async () => {
    ...
    setSaving(true);
    try {
      await apiClient("/api/twilio/credentials", {
        method: "POST",
        body: JSON.stringify({
          environment: env,
        ...
        <div className="border-b border-zinc-800/50 bg-[#09090b]/80 backdrop-blur-sm sticky top-0 z-10">
          <div className="max-w-lg mx-auto px-4 h-12 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <img src="https://www.twilio.com/favicon.ico" alt="Twilio" className="w-5 h-5 rounded" />
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="text-xs text-zinc-500 mb-1.5 block">Auth Token</label>
                  <input
                    type={showSecrets ? "text" : "password"}
                    value={authToken}
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder={env === "test" ? "+15005550006" : "+1234567890"}
                    className="w-full px-3 py-2 bg-zinc-900/50 border border-zinc-800 rounded-lg text-sm text-white placeholder-zinc-700 font-mono focus:outline-none focus:border-zinc-700 transition-colors"
                  />
                  <p className="text-[10px] text-zinc-600 mt-1">
                    {env === "test" ? "Use magic number +15005550006 for testing" : "Your Twilio phone number"}
                  </p>
                </div>
              </div>
